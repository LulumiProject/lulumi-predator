        ...
        if (is.windows) {
          sub = sub.concat([
            new MenuItem({
              ...
              click: () => this.onNewTab(this.windowId, 'https://github.com/LulumiProject/lulumi-predator/issues', true),
            }),
            new MenuItem({
    ...
    beforeMount() {
      ...
      if (process.env.NODE_ENV !== 'testing') {
        ...
        if (this.tabs.length === 0) {
          this.onNewTab(this.windowId, 'https://github.com/LulumiProject/lulumi-predator', true);
        }
      }
